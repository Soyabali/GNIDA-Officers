...
class ShopSizeRepo
{
  ...
  Future<List> getShopSize() async
  {
    ...
    try
    {
      ...
      var endPoint = "ShopSize/ShopSize";
      var shopSizeApi = "$baseURL$endPoint";
      print('------------17---shopSizeApi---$shopSizeApi');
      var headers = {
        'token': '$sToken'
      };
      var request = http.Request('GET', Uri.parse('$shopSizeApi'));
      ...
      if (response.statusCode == 200)
      {
        ...
        shopSizeList = parsedJson['Data'];
        print("Dist list Marklocation Api ----71------>:$shopSizeList");
        return shopSizeList;
      } else
      {
        hideLoader();
