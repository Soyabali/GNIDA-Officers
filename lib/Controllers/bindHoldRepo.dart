...
class BindHoldRepo
{
  ...
  Future<List> bindHold() async
  {
    ...
    try
    {
      ...
      var endPoint = "BindHoldSlots/BindHoldSlots";
      var bindHoldApi = "$baseURL$endPoint";
      print('------------17---bindHoldApi---$bindHoldApi');

      var headers = {
        'token': '$sToken'
      };
      var request = http.Request('GET', Uri.parse('$bindHoldApi'));
