...
import '../../Controllers/UpdateCitizenMalbaRequestRepo.dart';
...
class ActionOnMalbaRequest extends StatefulWidget {

  final sBeforePhoto, iTaskCode,sReqNo;

  ActionOnMalbaRequest(
      {super.key, this.sBeforePhoto, this.iTaskCode, double? lat, double? long, required this.sReqNo});


  @override
  State<ActionOnMalbaRequest> createState() =>
                        ...
                        ElevatedButton(
                            onPressed: () async {
                              ...
                              if (_formKey.currentState!.validate()
                                ...
                                var actiononSchedulepointresponse = await UpdateCitizenMalbaRequestRepo()
                                    .updateCitizenMalba(
                                    context,
                                    sReqNo,
                                    remarks,
                                ...
                                result =
                                "${actiononSchedulepointresponse['Result']}";
